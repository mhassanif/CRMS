// main controler class composing cars , renters & transactions
package myapp;
...
public class CRMS {
	...
	// holds list of cars , renteres & transaction
    ...
    //encapsulated private method used internally
 ...
 // Rent Car Method
    public void rentCar(String carID, String renterID, int daysRented, double distanceTraveled, boolean insuranceAdded) {
        ...
        // retrire the rent according to details
        double baseRent = car.calculateRent(daysRented, distanceTraveled, insuranceAdded);
        // pass the rent and get cost according to 
        // type of renter & other details        
        ...
        // so it doesnt show up as availible
        car.setRented(true);
        
        // Create a new transaction
        String transactionID = "T" + String.format("%05d", ++transactionCounter); // default transaction id format
        ...
        System.out.println("Car " + car.getCarID() + " succesfully rented by renter id " + renter.getRenterID());
...
//        System.out.println("Total rental cost for renter: " + rentalCost);
    ...
    public void returnCar(String carID, String renterID, double damageCost) {
        ...
        // add damage cost & complete transaction
